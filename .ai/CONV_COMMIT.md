...
4. *types* other than `fix:` and `feat:` are allowed, for example [@commitlint/config-conventional](https://github.com/conventional-changelog/commitlint/tree/master/%40commitlint/config-conventional) (based on the [Angular convention](https://github.com/angular/angular/blob/22b96b9/CONTRIBUTING.md#-commit-message-guidelines)) recommends `build:`, `chore:`, `ci:`, `docs:`, `style:`, `refactor:`, `perf:`, `test:`, and others.
   - **build:** modifications to build system or external dependencies/interfaces
   - **chore:** non-functional code changes, build process or tool configuration
   - **ci:** continuous integration workflow configuration changes
   - **docs:** documentation modifications, including README and API docs
   - **style:** code style adjustments such as indentation, spacing, or blank lines
   - **refactor:** code restructuring without changing functional logic
   - **perf:** performance improvements and optimizations
   - **test:** test case modifications, additions, or removals
...
- **English Specification:** https://www.conventionalcommits.org/en/v1.0.0/
- **Chinese Specification:** https://www.conventionalcommits.org/zh-hans/v1.0.0/
- **Official Repository:** https://github.com/conventional-commits/conventionalcommits.org
